...
import { BookMarked, GraduationCap, LayoutDashboard, Library, Lock, Sparkles } from "lucide-react";
import { useState } from "react";

const AdminLandingPage = () => {
    const [currentView, setCurrentView] = useState("")
  return <AnimatedBackground className="items-center justify-center">
