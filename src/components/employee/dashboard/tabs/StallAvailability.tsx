...
const StallAvailability: React.FC = () => {
  const [stalls, setStalls] = useState([
    { id: "STALL-001", size: "small", reserved: true, pending: false, isEmpty: false },
    { id: "STALL-002", size: "medium", reserved: false, pending: true, isEmpty: false },
    { id: "STALL-003", size: "large", reserved: false, pending: false, isEmpty: false },
  ]);
