        ...
        <div className="max-w-md w-full relative z-10">
          ...
          <div className="bg-gradient-to-br from-[#2a2f4a]/80 to-[#1e2337]/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-white/10 shadow-2xl p-6 sm:p-8 animate-book-open">
            ...
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-gray-300 text-sm sm:text-base mt-1.5 sm:mt-2 flex items-center justify-center gap-2">
                <BookMarked className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-400 shrink-0" />
