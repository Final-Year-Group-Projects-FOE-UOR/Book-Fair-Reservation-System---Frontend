"use client";
import {  Sparkles, Bookmark, Feather, Settings } from "lucide-react";

export default function StallConfigurationHeader() {
  return (
    <div className="flex justify-between items-center ">
      <div className="flex items-center gap-3">
        <div className="bg-linear-to-br from-blue-500 to-cyan-600 p-2 rounded-xl shadow-lg shadow-blue-500/50 relative">
          <Settings className="w-8 h-8 text-white animate-floating-book" />
        ...
        <div>
          ...
          <p className="text-[12px] text-gray-400 flex items-center gap-1">
            ...
            Manage and configure stall settings
          </p>
        </div>
      </div>
    </div>
